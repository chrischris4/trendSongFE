...
export const metadata: Metadata = {
  metadataBase: new URL('https://trend-songs.com'),
      ...
      <head>
        ...
        <script
          ...
          dangerouslySetInnerHTML={{ __html: JSON.stringify({
            ...
            '@type': 'WebSite',
            name: 'TrendSongs',
            url: 'https://trend-songs.com',
            description: 'The most played songs and albums right now in 30+ countries. Official Apple Music charts, updated daily.',
          }) }}
        />
      </head>
      <body>
